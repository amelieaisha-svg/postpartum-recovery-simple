        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="#features" className="px-6 py-3 rounded-full font-semibold text-primary-800 bg-white hover:bg-babyPinkSoft transition-colors ring-1 ring-black/5">
                See how it works
              </a>
            </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 -m-4 bg-babyPink/40 rounded-[2.5rem] blur-2xl" aria-hidden />
            <div className="relative bg-babyPinkSoft rounded-[2rem] aspect-square max-w-md mx-auto flex items-center justify-center shadow-sm ring-1 ring-black/5">
      ...
      <section id="features" className="bg-white py-20 md:py-28 border-y border-black/5">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-primary-900 mt-3 tracking-tight">How PostpartumRecovery helps</h3>
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 md:py-24">
        <div className="relative overflow-hidden bg-gradient-to-br from-babyPink to-warmPeach rounded-[2rem] px-8 py-14 md:py-20 text-center shadow-sm">
          <div className="relative z-10 max-w-xl mx-auto">
            <h3 className="text-3xl md:text-4xl font-bold text-primary-900 mb-4 tracking-tight">Ready to join your community?</h3>
